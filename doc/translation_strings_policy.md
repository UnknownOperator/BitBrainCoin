...
This document provides guidelines for internationalization of the BitBrainCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitbraincoin_en.ts` remains unchanged.
