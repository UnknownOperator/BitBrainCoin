...
This mechanism has been integrated into Bitcore-Node-BitBrainCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitbraincoinpay/insight-api-bitbraincoin#web-socket-api](https://github.com/bitbraincoinpay/insight-api-bitbraincoin#web-socket-api)
* API: [https://github.com/bitbraincoinpay/insight-api-bitbraincoin#instantsend-transactions](https://github.com/bitbraincoinpay/insight-api-bitbraincoin#instantsend-transactions)
...
By default, the BitBrainCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BitBrainCoin Core daemon:
