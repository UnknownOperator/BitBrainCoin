/* src/config/bitbraincoin-config.h.  Generated from bitbraincoin-config.h.in by configure.  */
/* src/config/bitbraincoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The BitBrainCoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "BitBrainCoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/bitbraincoinpay/bitbraincoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BitBrainCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BitBrainCoin Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitbraincoincore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bitbraincoin.org/"
