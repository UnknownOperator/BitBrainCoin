...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print BitBrainCoin address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "bitbraincoin",               "masternode",             &masternode,             true,  {} },
    { "bitbraincoin",               "masternodelist",         &masternodelist,         true,  {} },
    { "bitbraincoin",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "bitbraincoin",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "bitbraincoin",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "bitbraincoin",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
