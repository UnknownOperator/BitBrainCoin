    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  bitbraincoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the BitBrainCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BBC, 0.1 BBC, 1 BBC and 10 BBC -- sort of like the paper money you use every day.</li> \
