    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BBC-light"), QVariant("light"));
    ui->theme->addItem(QString("BBC-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BBC-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("BBC-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("BBC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BBC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BBC-traditional"), QVariant("trad"));
