...
2. run bitbraincoind with -printalert or -sendalert like this:
   /path/to/bitbraincoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.bitbraincoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/BitBrainCoin Core:0.12.0.58/"));
