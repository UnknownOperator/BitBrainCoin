...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid bitbraincoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid bitbraincoin address" in e.error['message'])
